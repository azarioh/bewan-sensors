 ...
 */
public class NetBytesOutSensor extends AbstractNetSensor  
{
    @Override
    ...
    {	
		...
		return new MeasurementImpl(queryTimeMillis, this.getPerIntervalValue(this.netInterface.getTxBytes()));
    } 
}
